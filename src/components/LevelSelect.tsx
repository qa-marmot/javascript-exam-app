...
export default function LevelSelectScreen({ exam, isLoggedIn }: LevelSelectScreenProps) {
  const { handleLevelSelect } = exam;

  return (
    <div className="min-h-dvh bg-gradient-to-br from-blue-50 to-indigo-100 overflow-hidden">
