...
export default function AuthForm({ onClose }: AuthFormProps) {
  ...
  // ユーザー名からSupabase互換のメールアドレスを生成
  const generateInternalEmail = (username: string): string => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-8 rounded-2xl shadow-2xl text-gray-900">
